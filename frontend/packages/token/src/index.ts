...
export const networks = {
  testnet: {
    ...
    contractId: "CCBCMKDH42ZEZK4XAMAPBEXVX73LFCWNOSFLCOBTSD27CIQNKT4WFUGA",
  }
} as const
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAABAAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAAAAAAdkZWNpbWFsAAAAAAQAAAAAAAAABG5hbWUAAAARAAAAAAAAAAZzeW1ib2wAAAAAABEAAAAA",
